# Ver 2.23 お知らせ全文更新（称号・プロフィール表示など追記）
...
def update_announcement(apps, schema_editor):
    ...
    Announcement.objects.filter(title=ANNOUNCEMENT_TITLE).update(content=ANNOUNCEMENT_CONTENT)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('frontend', '0006_update_v223_announcement_titles'),
    ]
